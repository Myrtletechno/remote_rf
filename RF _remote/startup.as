	...
	; Compiler options:
	;
	; -oiot_remote.cof -miot_remote.map --summary=default --output=default \
	; cc2500.p1 dht11.p1 Keypad.p1 LCD.p1 Main.p1 my_delays.p1 SPI.p1 \
	; ssd1306.p1 uart_config.p1 --chip=16F877A -P --runtime=default \
