...
//==============================================================================
void Oled_SetFont(const unsigned char *_font, unsigned char _width, unsigned char _height, unsigned char _min, uchar _max){
font2  = _font;
width  = _width;
height = _height / 8;
min    = _min;
...
//==============================================================================
void Oled_WriteChar(unsigned char c, uchar seg, uchar pag){
uint i, j;
uint x_seg, y_pag;
x_seg = seg;
y_pag = pag;
